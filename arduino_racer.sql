CREATE DATABASE  IF NOT EXISTS `arduino_racer` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `arduino_racer`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: arduino_racer
-- ------------------------------------------------------
...
INSERT INTO `difficulty` VALUES (1,'normal');
...
INSERT INTO `users` VALUES (1,'joske','vermeulen');
